...
For up-to-date snapshot links and restore instructions. See the [Base node snapshots documentation](https://docs.base.org/base-chain/node-operators/snapshots)
