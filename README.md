...
- **Node** — a running instance participating in the Base network.
- **Sequencer** — a component responsible for transaction ordering.
- **L2** — the Base Layer 2 network built on Ethereum.
