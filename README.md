...
This repository contains tooling and configuration for running and maintaining Base nodes.
It does not include application-level services or smart contract logic.
