...
Before building or running Base Node, make sure your system meets these requirements:

- **Go:** 1.21+  
- **Docker:** 24+  
- **Node.js:** 18+  
- **Foundry:** latest stable (`forge`, `cast`)

Using older versions may cause build failures or unexpected behavior.
